/*=========================================================================
  ...
  Module:    $RCSfile: itkMultiScaleHessianBasedMeasureImageFilter2.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMultiScaleHessianBasedMeasureImageFilter2_h
#define __itkMultiScaleHessianBasedMeasureImageFilter2_h
...
namespace itk
{
/**\class MultiScaleHessianBasedMeasureImageFilter2
 ...
 *
 * NOTICE: This version includes support for generating an output image of the
 * eigenvector associated with the minimum absolute eigenvalue of the Hessian -
 * Cory Quammen
 *
 */
...
class ITK_EXPORT MultiScaleHessianBasedMeasureImageFilter2 
: public
ImageToImageFilter< TInputImage,TOutputImage > 
{
public:
  /** Standard class typedefs. */
  typedef MultiScaleHessianBasedMeasureImageFilter2          Self;
  ...
  /** Get the eigenvector associated with eigenvalue of smallest absolute value
   * computed at the best response scale */
  const EigenvectorImageType* GetEigenvectorOutput() const
    {
    return static_cast<const EigenvectorImageType*>(this->ProcessObject::GetOutput(3));
    }
  ...
  itkSetMacro(GenerateEigenvectorOutput,bool);
  itkGetMacro(GenerateEigenvectorOutput,bool);
  itkBooleanMacro(GenerateEigenvectorOutput);
...
private:
  ...
  MultiScaleHessianBasedMeasureImageFilter2(const Self&); 
  ...
  bool m_GenerateEigenvectorOutput;
};

} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkMultiScaleHessianBasedMeasureImageFilter2.cxx"
#endif
